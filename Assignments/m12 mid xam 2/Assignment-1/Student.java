...
class Student implements Comparable<Student> {
    /**
     * { description of variable studentname }.
     */
    private String studentname;
    /**
     * { description of variable dateofbirth }.
     */
    ...
    private int s1;
    /**
     * { description of variable s2 }.
     */
    private int s2;
    /**
     * { description of variable s3 }.
     */
    private int s3;
    /**
     * { description of variable total }.
     */
    private int total;
    /**
     * { description of variable reserved }.
     */
    private String reserved;
    /**
     * { description of variable unreserved }.
     */
    ...
    Student(final String name, final int birth, final int sub1,
        final int sub2, final int sub3, final int tot,
        final String rese, final String unrese) {
